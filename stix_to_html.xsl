        ...
        <div id="{$id}" class="expandableContainer expandableSeparate collapsed"
          ...
          <div id="{$expandedContentId}" class="expandableContents">
            ...
            <xsl:choose>
              ...
              <xsl:when test="self::stix:Indicator|self::stixCommon:Indicator|self::indicator:Indicator|self::report:Indicator">
              ...
              <xsl:when test="self::stix:Incident|self::stixCommon:Incident|self::report:Incident">
